...
const PostFrom = ({post, action}: PostFormProps) => {
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea className="shad-textarea custom-scrollbar" placeholder="Type how you feel about it" {...field} />
                            </FormControl>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type='text' className="shad-input" placeholder="Where was this photo taken?" {...field}/>
                            </FormControl>
                            <FormMessage className="shad-form_message" />
                        </FormItem>
                    )}
